<div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            <li><a href="../data_petugas/read.php" class="nav-link"><i class="far fa-square"></i><span>DATA KELAS</span></a></li>
            <li><a href="../data_kelas/read.php" class="nav-link"><i class="far fa-square"><span>DATA KELAS</span></i></a></li>
            <li><a href="../data_siswa/read.php" class="nav-link"><i class="far fa-square"><span>DATA SISWA</span></i></a></li>
            <li><a href="../data_spp/read.php" class="nav-link"><i class="far fa-square"><span>DATA SPP</span></i></a></li>
            <li class="menu-header">Transaksi</li>
            <li><a href="blank.html" class="nav-link"><i class="far fa-square"><span>Transaksi Pembayaran</span></i></a></li>
            <li><a href="blank.html" class="nav-link"><i class="far fa-square"><span>History Pembayaran</span></i></a></li>
          ...
          <div class="mt-4 mb-4 p-3 hide-sidebar-mini">
            <a href="../logout.php" class="btn btn-primary btn-lg btn-block btn-icon-split">
              <i class="fas fa-sign-out-alt"></i> Documentation
            </a>
          </div>        </aside>
      </div>